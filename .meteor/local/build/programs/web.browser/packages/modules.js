...
install("erasaur:meteor-lodash");                                            // 77
install("stolinski:stylus-multi");                                           // 78
install("fortawesome:fontawesome");                                          // 79
install("callback-hook");                                                    // 80
install("spiderable");                                                       // 81
install("fastclick");                                                        // 82
install("dburles:collection-helpers");                                       // 83
install("ui");                                                               // 84
install("session");                                                          // 85
...
install("matb33:bootstrap-base");                                            // 107
install("matb33:bootstrap-glyphicons");                                      // 108
install("coffeescript");                                                     // 109
install("zimme:active-route");                                               // 110
install("gwendall:auth-client-callbacks");                                   // 111
install("meteortoys:toykit");                                                // 112
install("msavin:mongol");                                                    // 113
install("msavin:jetsetter");                                                 // 114
install("meteortoys:blueprint");                                             // 115
install("meteortoys:authenticate");                                          // 116
install("meteortoys:shell");                                                 // 117
install("meteortoys:method");                                                // 118
install("meteortoys:result");                                                // 119
install("meteortoys:autopub");                                               // 120
install("meteortoys:pub");                                                   // 121
install("meteortoys:sub");                                                   // 122
install("meteortoys:email");                                                 // 123
install("meteortoys:listen");                                                // 124
install("meteortoys:throttle");                                              // 125
install("meteortoys:status");                                                // 126
install("meteortoys:hotreload");                                             // 127
install("meteortoys:allthings");                                             // 128
install("webapp");                                                           // 129
